...
<body>
    ...
    <!-- <div class="top20">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus, corrupti sint laboriosam necessitatibus hic voluptatibus asperiores excepturi odio? Eius, esse?</p>a
    </div>
    </div> -->
...
<!-- <div class="text14">
        ...
        <input type="submit" value="SUBMIT PLASE"> -->
    </div> 
 </div> 
